...
Requires that comments explain the **why** or **intent** of the code, the legal context, the trade-offs or non-obvious logic, and **prohibits** redundant comments that describe what the code already shows.

## Why it matters

Redundant comments pollute the code and tend to become outdated, creating lies in the system. Forces code to be self-documented through good naming.

## Objective Criteria

- [ ] Using comments to describe what an obvious function does is prohibited (e.g., `// returns the value`).
- [ ] Comments should be used to explain non-evident business rules, performance trade-offs, or specific bug fixes.
...
- [022 - Prioritization of Simplicity and Clarity](002_prioritization-simplicity-clarity.md): complements
