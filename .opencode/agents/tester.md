...
| Planejamento de cobertura e edge cases | **software-quality** |
| Organização de test files | **colocation** |
...
| 5. Execução | `bun test --coverage` (fallback: `bunx vitest --coverage`) | Coverage report |
