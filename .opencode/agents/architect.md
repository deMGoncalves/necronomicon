...
| 2. Define path src/ | Determina `src/[context]/[container]/[component]/` conforme vertical slice | Path |
...
| 2. Mapeia domínio | Identifica contexts e containers afetados → define `src/[context]/[container]/[component]/` | Path src/ |
...
- [ ] Path src/ definido conforme vertical slice
...
- [ ] Fatores de qualidade McCall relevantes identificados
