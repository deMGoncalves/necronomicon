...
| 4. Lint | Executa `bunx biome check --write <arquivo>` — corrige antes de finalizar |
...
| 4. Validação | Verifica rules críticas + `bunx biome check --write` em cada arquivo | Código limpo |
| 5. Submissão | Envia para @tester | |
