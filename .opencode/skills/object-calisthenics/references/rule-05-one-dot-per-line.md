# Rule 5 — Um Ponto por Linha

**Rule deMGoncalves:** ESTRUTURAL-005
**Pergunta:** Esta linha tem múltiplos acessos encadeados (dots)?
...
- Linha contém `a.b().c()`
- Linha contém `object.getA().getB()`
- Código viola Law of Demeter
...
class OrderProcessor {
  process(order: Order): void {
    ...
    // Ou quebre em linhas separadas com intenção clara
