...
**Intenção:** Representar uma operação a ser executada sobre elementos de uma estrutura de objetos, permitindo definir nova operação sem alterar as classes dos elementos.
...
- Adicionar operações a classes sem modificá-las (respeita OCP)
- Quando há operações distintas sobre uma hierarquia de objetos estável
- Relatórios, validações e transformações sobre estruturas heterogêneas

## Quando NÃO Usar

- Quando a hierarquia de elementos muda frequentemente — adicionar novo tipo exige alterar todos os Visitors
...
- [iterator.md](iterator.md): complementa — Iterator percorre a estrutura; Visitor executa a operação em cada elemento
- [interpreter.md](interpreter.md): complementa — Visitor pode percorrer a árvore de expressões do Interpreter
- [rule 011 - Princípio Aberto/Fechado](../../../rules/011_principio-aberto-fechado.md): reforça — adicionar nova operação via novo Visitor sem alterar classes de elemento
- [rule 010 - Princípio da Responsabilidade Única](../../../rules/010_principio-responsabilidade-unica.md): reforça — cada Visitor tem uma única responsabilidade de operação
