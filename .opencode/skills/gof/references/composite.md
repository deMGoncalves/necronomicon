...
**Intenção:** Compor objetos em estruturas de árvore para representar hierarquias todo-parte, permitindo tratar objetos individuais e composições uniformemente.
...
- Para representar estruturas recursivas de forma natural
- Em parsers e ASTs (Abstract Syntax Trees)
...
- Quando operações diferem muito entre folhas e nós compostos
...
```typescript
const menu = new MenuCategory('Lanches')
...
- [rule 064 - Proibição de Overengineering](../../../rules/064_proibicao-overengineering.md): reforça — não usar para estruturas não hierárquicas
