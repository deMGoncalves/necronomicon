...
- Objeto tem muitos parâmetros opcionais no construtor (evita telescoping constructors)
- Construção do objeto envolve múltiplas etapas ou configurações
- Diferentes representações de um objeto a partir do mesmo processo de construção
- Ao construir queries SQL, requests HTTP, ou objetos de configuração
...
- [rule 064 - Proibição de Overengineering](../../../rules/064_proibicao-overengineering.md): reforça — não usar para objetos simples
- [rule 005 - Máximo Uma Chamada por Linha](../../../rules/005_maximo-uma-chamada-por-linha.md): complementa — fluent interface do Builder é exceção permitida ao encadeamento
