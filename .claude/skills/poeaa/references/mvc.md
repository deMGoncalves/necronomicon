...
- Quando lógica de apresentação deve ser separada da lógica de negócio
...
- Nunca — MVC é adequado para qualquer tamanho de aplicação web
- Em aplicações muito simples pode-se simplificar, mas a separação sempre vale
...
- [page-controller.md](page-controller.md): complementa — Page Controller é uma implementação simplificada do papel Controller no MVC
- [rule 010 - Princípio da Responsabilidade Única](../../../rules/010_principio-responsabilidade-unica.md): reforça — separa claramente responsabilidades de dados, apresentação e coordenação
