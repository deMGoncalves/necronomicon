...
- Reactive programming e data binding
- Notificações de mudança de estado em múltiplos consumidores
- Implementar listeners e callbacks de forma estruturada

## Quando NÃO Usar

- Quando esquecer de `unsubscribe` causa memory leaks (rule 070 — Estado Mutável Compartilhado)
...
- [rule 070 - Proibição de Estado Mutável Compartilhado](../../../rules/070_proibicao-estado-mutavel-compartilhado.md): reforça — não esquecer de `unsubscribe` para evitar memory leaks e referências obsoletas
