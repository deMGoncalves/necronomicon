...
**Intenção:** Fornecer substituto ou placeholder para outro objeto para controlar o acesso a ele.
...
- Quando não adiciona comportamento real — vira Middle Man inútil (rule 061)
- Para simples delegação sem controle, cache ou acesso — use o objeto diretamente
- Quando a latência do Proxy supera o benefício que ele provê
