...
**Seção:** 10 de 12
**Audiência:** Todos (gestão para quality tree; técnico para métricas e cenários)
**Quando atualizar:** Ao revisar RNFs de §1, ao adicionar novo atributo de qualidade, ao mudar meta de cobertura ou SLA.
