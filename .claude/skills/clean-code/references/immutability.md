# Imutabilidade e Estado (Rules 029, 036, 038)

## Regras

- **029**: Value Objects e Entities imutáveis (`Object.freeze()`)
- **036**: Funções puras (sem side effects em Queries)
- **038**: Separação Command-Query (CQS)
...
- [ ] Métodos são Query XOR Command (nunca híbrido)
