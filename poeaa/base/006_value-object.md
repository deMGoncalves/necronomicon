...
Objeto pequeno e simples cuja igualdade não é baseada em identidade.
...
Value Object resolve o problema de representar um objeto pequeno e simples cuja igualdade não é baseada em identidade.

Este padrão é especialmente útil em aplicações empresariais onde a complexidade e a escala exigem soluções estruturadas e bem definidas. Ao aplicar o Value Object, você obtém uma abordagem testada e comprovada que já foi validada em incontáveis projetos reais.
...
- Você precisa de uma solução para representar um objeto pequeno e simples cuja igualdade não é baseada em identidade
...
Interação:
Client → Value Object → Sistema Externo
```
