...
Objeto global bem conhecido para localizar objetos e serviços comuns.
...
Registry resolve o problema de ter um objeto global bem conhecido para localizar objetos e serviços comuns.

Este padrão é especialmente útil em aplicações empresariais onde a complexidade e a escala exigem soluções estruturadas e bem definidas. Ao aplicar o Registry, você obtém uma abordagem testada e comprovada que já foi validada em incontáveis projetos reais.
...
- Você precisa de uma solução para ter um objeto global bem conhecido para localizar objetos e serviços comuns
...
Interação:
Client → Registry → Sistema Externo
```
