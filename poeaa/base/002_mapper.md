...
Objeto que estabelece a comunicação entre dois subsistemas independentes.
...
Mapper resolve o problema de estabelecer comunicação entre dois subsistemas independentes.

Este padrão é especialmente útil em aplicações empresariais onde a complexidade e a escala exigem soluções estruturadas e bem definidas. Ao aplicar o Mapper, você obtém uma abordagem testada e comprovada que já foi validada em incontáveis projetos reais.
...
- Você precisa de uma solução para estabelecer comunicação entre dois subsistemas independentes
