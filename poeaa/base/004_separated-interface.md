...
Interface defined in a separate package from its implementation.
...
Separated Interface solves the problem of interface defined in a separate package from its implementation.

This pattern is especially useful in enterprise applications where complexity and scale require structured and well-defined solutions. By applying Separated Interface, you get a tested and proven approach that has already been validated in countless real projects.
...
- You need a solution for interface defined in a separate package from its implementation
...
Interaction:
Client → Separated Interface → External System
```
