...
Interface definida em um pacote separado da sua implementação.

## Também Conhecido Como

- Interface Segregation
- Package-Separated Interface

## Motivação

Separated Interface resolve o problema de definir uma interface em um pacote separado da sua implementação.

Este padrão é especialmente útil em aplicações empresariais onde a complexidade e a escala exigem soluções estruturadas e bem definidas. Ao aplicar o Separated Interface, você obtém uma abordagem testada e comprovada que já foi validada em incontáveis projetos reais.
...
Use Separated Interface quando:

- Você precisa de uma solução para definir uma interface em um pacote separado da sua implementação
...
Interação:
Client → Separated Interface → Sistema Externo
```
