...
Objeto que encapsula o acesso a um sistema externo ou recurso.
...
Gateway resolve o problema de encapsular o acesso a um sistema externo ou recurso.

Este padrão é especialmente útil em aplicações empresariais onde a complexidade e a escala exigem soluções estruturadas e bem definidas. Ao aplicar o Gateway, você obtém uma abordagem testada e comprovada que já foi validada em incontáveis projetos reais.
...
- Você precisa de uma solução para encapsular o acesso a um sistema externo ou recurso
...
Interação:
Client → Gateway → Sistema Externo
```
