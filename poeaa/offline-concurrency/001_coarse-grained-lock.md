...
Coarse-Grained Lock solves the problem of locking a set of related objects with a single lock.

This pattern is especially useful in enterprise applications where complexity and scale require structured and well-defined solutions. By applying Coarse-Grained Lock, you get a tested and proven approach that has already been validated in countless real projects.
...
- You need a solution to lock a set of related objects with a single lock
...
Interaction:
Client → Coarse-Grained Lock → External System
```
